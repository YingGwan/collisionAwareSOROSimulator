...
public:
	...
	/// <summary>
	/// Self collision type:
	///	@ 0 -> last iteration not self collision, but this iteration is collision
	///	  1 -> last is and this is collision
	///   2 -> not collision but among the true boundary and boundary 3
	/// </summary>
	int _selfCollisionType = -1;
