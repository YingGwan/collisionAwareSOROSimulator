...
public:
    ...
    void getMesh(QMeshPatch* inputMesh, int maxIterTime);

    void buildSimulationSystem();
    void buildSimulationSystem(std::vector<Eigen::MatrixXd>& initShape, bool isfirstIter);
    ...
    double expandRatio[3] = { 1.0,1.0,1.0 };
...
private:
    ...
    void _compLocalGoalandInverse_protectedBodyEle(
...
private:
    ...
    double _calEleVolume(Eigen::MatrixXd& inputEle);
